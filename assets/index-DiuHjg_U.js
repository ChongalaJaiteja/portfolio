import{u as i,j as e}from"./index-GC7tL9c-.js";import{j as o}from"./constants-DAKkPJq8.js";const p=i(o.li)`
    display: flex;
    align-items: center;
    gap: 0.6em;
...
`,d=i.p`
    ...
    padding-right: 0.4em;
`,v=({itemDetails:a,index:t})=>{const{icon:l,name:n}=a,r={initial:{opacity:0,y:22},animate:m=>({opacity:1,y:0,transition:{delay:.16*m,type:"spring"}})};return e.jsxs(p,{initial:"initial",variants:r,whileInView:"animate",custom:t,viewport:{once:!0},whileHover:{scale:1.04},children:[e.jsx(c,{children:l}),e.jsx(d,{children:n})]})};export{v as default};
